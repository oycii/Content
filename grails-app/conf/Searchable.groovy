...
searchable {
    ...
    compassConnection = new File(
        "${userHome}/data/index/${appName}/searchable-index"
    ).absolutePath

    /**
     Map compassSettings = [
             'compass.engine.analyzer.russian.type': 'Russian'
     ] */
     ...
     */
     Map compassSettings = ['compass.engine.analyzer.russian.type': 'Russian']
    ...
    defaultMethodOptions = [
        search: [reload: false, escape: false, offset: 0, max: 10, defaultOperator: "and", analyzer: "russian"],
