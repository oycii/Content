<html>
	...
	<body>
		...
		<g:if test="${session?.phoneid != null}">
			<div class="category"><b><g:link controller="game" action="phonecontent" params="[phoneid:session?.phoneid, category:'game']">Игры для твоего телефона ${phone.model}</g:link></b></div>
